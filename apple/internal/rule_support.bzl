...
#     sign_with_provisioning_profile: Only sign binaries and frameworks if a provisioning profile
#         was specified at the target level. Will not sign with entitlements in this case.
